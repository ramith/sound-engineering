...
static void zeroOutputChannels(const MultichannelView& output,
                               vDSP_Length vLen) noexcept
{
...
void SpatialRenderKernel::initialize(uint32_t sampleRate, uint32_t maxFrames) noexcept
{
...
void SpatialRenderKernel::configure(uint32_t inChannels, uint32_t outChannels) noexcept
{
...
void SpatialRenderKernel::process(const MultichannelView& input,
                                  const MultichannelView& output) const noexcept
{

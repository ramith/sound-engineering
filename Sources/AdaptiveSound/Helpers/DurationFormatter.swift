...
/// A VoiceOver-friendly spoken duration — e.g. 225 → "3 min 45 sec" — for the Songs row
/// accessibility label. The visible Time column shows "3:45", which screen readers voice poorly;
/// spelled minutes + seconds read cleanly. Abbreviated units, matching `humaneTotalDuration`'s style.

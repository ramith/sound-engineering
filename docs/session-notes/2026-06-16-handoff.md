...
> **📦 ARCHIVED — historical multi-device handoff (2026-06-16).** Known-stale Phase-0 snapshot — do not follow its instructions; read the code and [`../sprints/sprint-plan.md`](../sprints/sprint-plan.md). The Phase-0 docs it references now live beside this file as `2026-06-16-phase0-*.md`.

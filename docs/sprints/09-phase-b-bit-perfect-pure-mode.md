...
Status: **Phase B effectively complete** (2026-06-18) — all code on `feat/sprint-5-eq-wiring`,
pending only the founder's on-hardware smoke of the integer bit-perfect path (a **USB DAC** or a
48 kHz source — see "HDMI reality" below). Authoritative plan: `~/.claude/plans/functional-floating-bonbon.md`.

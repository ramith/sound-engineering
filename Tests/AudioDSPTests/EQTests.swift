...
struct EQTests {
    ...
    // Processing helpers, CEQParams factories, and signal generators used by the tests above
    // live in EQTests+Helpers.swift (kept out of this file to stay under SwiftLint
